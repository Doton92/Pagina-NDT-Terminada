...
$sql = "INSERT INTO usuarios (name, last_name, email, msg)
VALUES ('". $_POST['name'] ."','" .$_POST['last_name'] ."','" .$_POST['email'] ."','" .$_POST['msg'] ."')";
...
<html lang="es">
    ...
    <body>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            >
                                <li>
                                    <a
                                        class="dropdown-item"
                                        href="https://asnt.org/" target="_BLANK"
                                        >ASNT</a
                                    >
                                </li>
                                <li>
                                    <a
                                        class="dropdown-item"
                                        href="https://www.asme.org/" target="_BLANK"
                                        >ASME</a
                                    >
                                </li>
                            </ul>
        ...
        <div class="alert alert-success" role="alert">
          Se ha registrado tu mensaje correctamente!
        </div>
